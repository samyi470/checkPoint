# Generated by Django 3.1.6 on 2021-06-24 07:20
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('checkPointMng', '0017_delete_lasday'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primaryMonth', models.CharField(choices=[('January', 'January'), ('February', 'February'), ('March', 'March'), ('April', 'April'), ('May', 'May'), ('June', 'June'), ('July', 'July'), ('August', 'August'), ('September', 'September'), ('October', 'October'), ('November', 'November'), ('December', 'December')], max_length=9)),
            ],
        ),
    ]
