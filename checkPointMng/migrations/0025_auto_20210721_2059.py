...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('checkPointMng', '0024_auto_20210721_2058'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='phxday',
            name='terminal',
            field=models.CharField(choices=[('T-2', 'T-2'), ('T-3 NORTH', 'T-3 NORTH'), ('T-4 A', 'T-4 A'), ('T-4 B', 'T-4 B'), ('T-4 C', 'T-4 C'), ('T-4 D', 'T-4 D')], max_length=9),
        ),
    ]
